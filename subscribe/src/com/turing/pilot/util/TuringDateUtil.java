...
//    }
    ...
    public static String TuringToString(Date date)
    {
        return TuringToString(date, "yyyy-MM-dd");
    }

    public static String TuringToString(Date date, String format)
    {
