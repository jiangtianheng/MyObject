...
public class TuringStringUtil {
	...
	public static RequestBean stringToBean(final String str, final String delimiter) {
	...
	private static void setBean(RequestBean request, String trim, String trim2) {
		request.addParam(trim, trim2);
	}
