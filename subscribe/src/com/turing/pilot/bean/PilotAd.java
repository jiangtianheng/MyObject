...
public class PilotAd implements Serializable {
	...
	public void setOffer_type(Integer offerType) {
	...
	public String getUnaffiliates() {
		return unaffiliates;
	}

	public void setUnaffiliates(String unaffiliates) {
		this.unaffiliates = unaffiliates;
	}
