...
import com.turing.cache.key.KeyInfo;
...
public class RedisFactory {
	...
	private static RedisFactory redisFactory = new RedisFactory();

	public static RedisFactory getClient() {
		return redisFactory;
	}
	...
	private static class RedisFactoryHolder {
		...
		static {
			if (jedisCluster == null) {
				...
				jedisCluster = new JedisCluster(nodes, redisConfig.getJedisPoolConfig());
			}
		}
	}
	...
	public static String hmset(String key, Map<String, String> value, int liveTime) {
		JedisCluster redis = null;
		try {
			redis = getInstance();
	 ...
	 * @return
	 */
	public long hincrBy(KeyInfo keyInfo, String field, long value) {
		JedisCluster redis = null;
		long result = 0;
		try {
			redis = getInstance();
