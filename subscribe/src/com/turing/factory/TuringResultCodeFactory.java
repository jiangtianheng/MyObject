...
public class TuringResultCodeFactory {
	/**
	 * api返回结果类型的工厂
	 */
	/**
	 ...
	 * 服务器异常，返回结果不可用
	 * */
	public static final int SERVER_TYPE_ERROR = -1;
	/**
	 * 读取log4j
	 * */
	//截取位置
	public static final String location  =" /data/tools/apache-tomcat";
	//地址
	public static final String Log4jUrl  ="D:\\test.log";
	// 管理后台状态码
	public static final int REQUEST_ADMIN_SUCCESS = 1;
