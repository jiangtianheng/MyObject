...
public class TuringRedisFactory
{
    /**
     * 1分钟过期
     * */
    ...
    private static Jedis getInstance()
    {
        if (pool == null)
        {
            redisConnFactory = (JedisConnectionFactory) TuringSpringHelper
                    .getBean("redisConnectionFactory");
            
            pool = new JedisPool(redisConnFactory.getPoolConfig(),
                    redisConnFactory.getHostName(), redisConnFactory.getPort(),ALWAYS,redisConnFactory.getPassword());
            ...
            JedisConnectionFactory redisConnFactory)
    {
        ...
        {
            TuringRedisFactory.redisConnFactory = redisConnFactory;
        }
    }
