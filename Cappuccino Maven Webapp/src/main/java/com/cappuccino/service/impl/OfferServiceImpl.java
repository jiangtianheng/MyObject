...
public class OfferServiceImpl implements OfferService
{
    ...
    @Override
    public Map<String, Object> getAllOffersInfo(String apikey, Integer page,
            Integer limit, String countries, Integer os, Double min, Double max)
    {

        Map<String, Object> offer_map = new HashMap<String, Object>();

        /** redis key */
        String redis_offerKey = GlobalConst.OFFER_KEY + apikey + page + limit
                + countries + os + min + max;
        ...
        else
        {
            ...
            List<OfferInfoEntity> offerinfo = offers.getAllOffersInfo(apikey,
                    countries, os, min, max);
            if (null == offerinfo)
            {
                return null;
            ...
            else
            {
                ...
                PageInfo<OfferInfoEntity> pageInfo = new PageInfo<OfferInfoEntity>(
                        offerinfo);
                ...
                RedisFactory.set(redis_offerKey, offer_map,
                        RedisFactory.FIFTEEN_MINUTE);
            }
        }
        return offer_map;
    }
    ...
    public static Map<String, Object> handleData(OfferInfoEntity entity)
    {
        ...
        String tracking_link = entity.getTracklink()
                + "&sub={sub}&idfa={idfa}&gaid={gaid}&devid={devid}";
