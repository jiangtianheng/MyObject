											...
											<div class="col-lg-10 col-md-9 col-sm-9 col-xs-9">
												<div class="row">
													<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 m-b-sm">
														<h4>
															<img class="os-logo"
																...
																- Incent </a> <a href="#"> <i class="fa fa-asterisk"
																style="color:#FF5555" title="Incent"></i> </a>
													...
													<div class="col-xs-12 col-sm-12 col-md-12 col-lg-3 m-b-md">
														<span style="line-height: 24px"> <a href="#"
										...
										<div class="row"
											...
											<div class="col-lg-10 col-md-9 col-sm-9 col-xs-9">
												<div class="row">
													...
													<div class="col-xs-12 col-sm-12 col-md-12 col-lg-3 m-b-md">
														<span style="line-height: 24px"> <a href="#"
															class="label" title="United States">US</a> <a href="#"
															class="label" title="Germany">DE</a> <a href="#"
															class="label" title="Japan">JP</a> </span> <span
															style="line-height: 24px"> <a href="#"
													...
													<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 m-b-sm">
														<h4>
															<img class="os-logo"
																src="http://publishers.turbob.mobi/_assets/img/android_logo.png"
																title="Android" style="margin-top: -4px"> <a
																href="#"> Bitbop - LIVE (Android 3.0+) AE - Non
																incent </a>
														</h4>
														<div style="line-height: 24px">
															<span class="label" title="Offer ID"
