...
import com.cappuccino.offer.offers.android.v1.PullOfferV1;

public class PullOfferJob {

	private static Logger logger = Logger.getLogger(PullOfferJob.class);
	private JobExecutorService jobExecutorService = JobExecutorService.getInstance();
