	...
	private static class RedisClusterClientHolder{
		...
		static{
			if (jedisCluster == null) {
				redisConfig =  SpringHelper.getBean("redisConfig", RedisConfig.class);
				Set<HostAndPort> nodes = new HashSet<HostAndPort>();
				nodes.add(new HostAndPort(redisConfig.getHost(), redisConfig.getPort()));
				jedisCluster = new JedisCluster(nodes, redisConfig.getTimeOut(),redisConfig.getJedisPoolConfig());
			}
		}
	}
